...
<div class="entry">
<div>
<h3>创建Struts 2.0步骤：</h3>
【1】在web.xml添加struts 2支持
...
<ul>  
  ...
  <li>struts2-core-2.3.20.jar</li>
  <li>xwork-core-2.3.20.jar</li>
</ul>
【3】创建struts.xml文件
<pre class="brush:javascript;gutter:true">
...
【4】在index.jsp里面添加</br><%@taglib prefix="s" uri="/struts-tags"%>
<pre class="brush:javascript;gutter:true">
<s:form action="UserLogin.action" method="get"> 
<s:textfield name="name" label="用户名" requiredPosition="left"></s:textfield>
<s:password name="passwd" label="用户密码"></s:password>
...
public class UserLogin extends ActionSupport {
  ...
  public String Login()
  {
    if(this.name.equals("yu") && this.passwd.equals("111")) return "success";
    else return "input";
  }
}
</pre>
【2】添加struts.xml文件
<pre class="brush:javascript;gutter:true">
    <action name="UserLogin" class="com.mypackge.UserLogin" method="Login">
      <result name="success">/first.jsp</result>
      <result name="input">/index.jsp</result>
    </action>
</pre>
【3】添加数据效验文件UserLogin-validatation.xml
<pre class="brush:javascript;gutter:true">
...
<validators>
    <field name="name">
        <field-validator type="requiredstring">
            <message>name is missing!</message>
        </field-validator>
    </field>
</validators>
</pre>
