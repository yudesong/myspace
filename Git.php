...
<p>Git 是 Linus Torvalds 为了帮助管理 Linux 内核开发而开发的一个开放源码的版本控制软件。
<p>Git 与常用的版本控制工具 CVS, Subversion 等不同，它采用了分布式版本库的方式，不必服务器端软件支持。</br>
<strong>Git 与 SVN 区别</strong>
<ul>
...
<strong>Git 配置</strong>
<p><strong>配置个人的用户名称和电子邮件地址</strong>
<pre class="brush:javascript;gutter:true">
$ git config --global user.name "w3c"
$ git config --global user.email w3c@w3cschool.cc
</pre>
<p><strong>Git 创建仓库</strong>
<pre class="brush:javascript;gutter:true">
$ git init
$ git init newrepo  //指定目录作为Git仓库
</pre>
初始化后，在当前目录下会出现一个名为 .git 的目录，所有 Git 需要的数据和资源都存放在这个目录中。</br>
如果当前目录下有几个文件想要纳入版本控制，需要先用 git add 命令告诉 Git 开始对这些文件进行跟踪，然后提交：
<pre class="brush:javascript;gutter:true">
$ git add *.c   //将所有.c文件添加到缓存
$ git add README 
...
执行该命令后，会在当前目录下创建一个名为grit的目录，其中包含一个 .git 的目录，用于保存下载下来的所有版本记录。</br>
<p><strong>添加远程库</strong>
<pre class="brush:javascript;gutter:true">
$ git remote add [shortname] [url]
</pre>
<p><strong>提取远程仓库</strong>
<pre class="brush:javascript;gutter:true">
$ git fetch [alias]
$ git pull [alias]
</pre>
...
<p><strong>推送到远程仓库</strong>
<pre class="brush:javascript;gutter:true">
$ git push [alias] [branch]
</pre>
<p><strong>删除远程仓库</strong>
<pre class="brush:javascript;gutter:true">
$ git remote rm [别名]
</pre>
