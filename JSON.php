...
<p></p>
<p><strong>JSON - 转换为 JavaScript 对象</strong></p>
<span>
JSON 文本格式在语法上与创建 JavaScript 对象的代码相同。</br>
由于这种相似性，无需解析器，JavaScript 程序能够使用内建的 eval() 函数，用 JSON 数据来生成原生的 JavaScript 对象。
</span>
<p></p>
<p><strong>JSON 语法规则</strong></p>
<span>JSON 语法是 JavaScript 对象表示法语法的子集。</span>
<ul>
	<li>数据在名称/值对中</li>
	<li>数据由逗号分隔</li>
	<li>花括号保存对象</li>
...
<span>JSON 数据的书写格式是：名称/值对。</br>
名称/值对包括字段名称（在双引号中），后面写一个冒号，然后是值："firstName":"John"</br>
</span>
<strong>JSON 值</strong>
<span>
	<ul>
		<li>数字（整数或浮点数）</li>
		<li>字符串（在双引号中）</li>
...
<strong>JSON 使用 JavaScript 语法</strong>
<span>
因为 JSON 使用 JavaScript 语法，所以无需额外的软件就能处理 JavaScript 中的 JSON。</br>
...
<p></p>
<p><strong>把 JSON 文本转换为 JavaScript 对象</strong></p>
<span>JSON 最常见的用法之一，是从 web 服务器上读取 JSON 数据（作为文件或作为 HttpRequest），将 JSON 数据转换为 JavaScript 对象，然后在网页中使用该数据。</span>
<pre class="brush:javascript;gutter:true">
var txt = '{"employees":[' +
'{"firstName":"John","lastName":"Doe" },' +
'{"firstName":"Anna","lastName":"Smith" },' +
