...
<p></p>
<strong>AJAX - 创建 XMLHttpRequest 对象</strong>
<span>创建 XMLHttpRequest 对象的语法：</span>
<img src="images/ajax1.png"></img>
...
<span>一个简单的 GET 请求：</span>
<pre class="brush:javascript;gutter:true">
xmlhttp.open("GET","demo_get.html?t=" + Math.random(),true);
xmlhttp.send();
</pre>
<span>一个简单的 POST 请求：</span>
<pre class="brush:javascript;gutter:true">
...
<p></p>
<p><strong>AJAX - onreadystatechange 事件</strong></p>
<img src="images/ajax2.png"></img>
<pre class="brush:javascript;gutter:true">
...
<pre class="brush:javascript;gutter:true">
	...
	if(null==xhr) alert("创建XMLHttpRequest失败！");
	...
	xhr.onreadystatechange=function()
	{
		...
		/*获取JSON对象
			...
			document.getElementById("show").innerHTML=ob.employees[0].firstName;
		*/
	...
	xhr.open("GET","test.txt?t="+Math.random(),true);
//	xhr.open("GET","test.xml?t="+Math.random(),true);
//	xhr.open("GET","test.json?t="+Math.random(),true);
